...
# Update/Download Configuration (Point to the GZIP URL)
URL_PATH = "https://github.com/sapics/ip-location-db/releases/download/latest/geolite2-city-ipv4-num.csv.gz"
FILE_PATH = "csv/geolite2-city-ipv4-num.csv.gz"
