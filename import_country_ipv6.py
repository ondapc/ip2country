...
URL_PATH = "https://github.com/sapics/ip-location-db/releases/download/latest/geolite2-country-ipv6-num.csv" 
FILE_PATH = "csv/geolite2-country-ipv6-num.csv" 

# 2. Database connection parameters
TABLE_NAME = "country_v6"
