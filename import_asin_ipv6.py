...
URL_PATH = "https://github.com/sapics/ip-location-db/releases/download/latest/origin-asn-ipv6-num.csv"
FILE_PATH = "csv/origin-asn-ipv6-num.csv" 
...
dtype_mapping = {
    ...
    "autonomous_system_number": types.VARCHAR(length=220),
    "autonomous_system_organization": types.VARCHAR(length=220)
}
