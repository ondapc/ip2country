...
URL_PATH = "https://github.com/sapics/ip-location-db/releases/download/latest/origin-asn-ipv4-num.csv"
FILE_PATH = "csv/geolite2-asn-ipv4-num.csv" 
...
dtype_mapping = {
    ...
    "autonomous_system_number": types.BigInteger(),
